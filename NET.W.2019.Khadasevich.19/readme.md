1. ¬ текстовом файле построчно хранитс€ информаци€ о URL-адресах,
...
–азработать систему типов (руководствоватьс€ принципами SOLID) дл€
экспорта данных, полученных на основе разбора информации текстового файла, в
XML-документ по следующему правилу, например, дл€ текстового файла с URL-
адресами
...
результирующим €вл€етс€ XML-документ вида (можно использовать любую XML
